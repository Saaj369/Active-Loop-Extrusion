...
void integrate_and_simulate(int steps, int saveFreq)
{
    ...
    string stateFile = "dataDNA/smc_data_noCTCF_15FEB_53_1.txt";
    ...
    //**********************************Writing Sim Info*************************************
    out << "Goal : Study the change in Bound cohesin number with Mu." << endl;
    out << "CTCFs : No" << endl;
    out << "N : " << NUM_PARTICLES << endl;
    out << "h : " << h << endl;
    out << "Mu : " << Mu << endl;
    out << "freq : " << saveFreq << endl; 
    ...
    // polystate[200].setState(3); // (+) oriented CTCF
    // polystate[300].setState(4); // (-) oriented CTCF
    // polystate[400].setState(3); // (+) oriented CTCF
    // polystate[600].setState(4); // (-) oriented CTCF
    ...
    cout << "Equilibriating for => " << 0 <<endl;
